...
import { navigateSchema, startPreviewSessionSchema } from '@/features/play/play.validation';
...
router.post('/sessions', validateRequest(startPreviewSessionSchema), (req, res, next) => {
