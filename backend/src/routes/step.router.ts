...
import { createStepParamsSchema, strictStepCreateSchema } from '@/utils/validation/schemas/step.schema';
...
stepRouter.post(
  ...
  validationMiddleware({
    bodySchema: strictStepCreateSchema,
    paramsSchema: createStepParamsSchema,
  }),
  (req, res, next) => {
